...
export default function ClientsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setModalOpen(false);
      setForm({ name: "", email: "", phone: "", destination: "" });
      fetchClients();
    } catch {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">
            {isAdmin ? "Manage all clients" : "View your assigned clients"}
          </p>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-yellow-50 text-gray-600 text-left">
                  ...
                  {isAdmin && <th className="px-5 py-3 text-center">Actions</th>}
                </tr>
              </thead>
              <tbody>
                {filtered.map((c, i) => (
      ...
      {modalOpen && isAdmin && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-bold text-yellow-700 mb-4">Add New Client</h2>
